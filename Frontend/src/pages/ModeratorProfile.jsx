      ...
      {profile ? (
        <ProfileRows
          ...
          rows={[
            ...
            { key: "role", label: "Role", value: profile.role, icon: Shield },
        ...
        <div className="modal-backdrop" role="presentation">
          <section className="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="logout-title">
            ...
            <div className="modal-actions">
              ...
              <button className="secondary-button icon-action-button" type="button" onClick={handleSignOut} disabled={signingOut}>{signingOut ? "Signing out..." : "Sign out"}</button>
            </div>
          </section>
        </div>
      ) : null}
